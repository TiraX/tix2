...
namespace tix
{
	...
	{
		sizeof(D3D12_VERTEX_BUFFER_VIEW),		//COMMAND_SET_VERTEX_BUFFER
		sizeof(D3D12_VERTEX_BUFFER_VIEW),		//COMMAND_SET_INSTANCE_BUFFER
		sizeof(D3D12_INDEX_BUFFER_VIEW),		//COMMAND_SET_INDEX_BUFFER,
