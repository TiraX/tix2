...
namespace tix
{
	...
	public:
		...
		void setX(f32 val) { X = val; }
		void setY(f32 val) { Y = val; }
		void setZ(f32 val) { Z = val; }
		void setW(f32 val) { W = val; }
