...
inline float GetFaceWeight4U(FGeometrySDF* SDF, const vector3df& P, const vector3df& CellSize)
{
...
inline float GetFaceWeight4V(FGeometrySDF* SDF, const vector3df& P, const vector3df& CellSize)
{
	float Sdf0 = SDF->SampleSDFByPosition(P);
...
inline float GetFaceWeight4W(FGeometrySDF* SDF, const vector3df& P, const vector3df& CellSize)
{
	float Sdf0 = SDF->SampleSDFByPosition(P);
	float Sdf1 = SDF->SampleSDFByPosition(P + vector3df(0.f, CellSize.Y, 0.f));
	float Sdf2 = SDF->SampleSDFByPosition(P + vector3df(CellSize.X, 0.f, 0.f));
