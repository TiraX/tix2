...
namespace tix
{
	TResPipelineHelper::TResPipelineHelper()
	{
	}
	...
	bool TResPipelineHelper::LoadPipeline(const TString& Filename, TStream& OutStream, TVector<TString>& OutStrings)
	{
		return true;
	}
	
	void TResPipelineHelper::OutputPipeline(TStream& OutStream, TVector<TString>& OutStrings)
	{
