...
class FClusterDispatchCmdCS : public FComputeTask
{
public:
	FClusterDispatchCmdCS();
	virtual ~FClusterDispatchCmdCS();
...
typedef TI_INTRUSIVE_PTR(FClusterDispatchCmdCS) FClusterDispatchCmdCSPtr;
